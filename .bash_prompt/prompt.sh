...
userColor="\[\e[38;5;36m\]" # x036_DarkCyan
#userColor="\[\e[38;5;42m\]" # x042_SpringGreen2
#userColor="\[\e[38;5;48m\]" # x048_SpringGreen1

rootColor="\[\e[38;5;124m\]" # x124_Red3
#rootColor="\[\e[38;5;125m\]" # x125_DeepPink4
#rootColor="\[\e[38;5;160m\]" # x160_Red3

[[ "$(id -u)" -eq 0 ]] &&
    promptColor="$rootColor" ||
